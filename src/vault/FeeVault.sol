...
contract FeeVault is ERC4626, AccessControl, ReentrancyGuard, IFeeVault {
    ...
    constructor(address usdc, address admin) ERC4626(IERC20(usdc)) ERC20("Fee Vault Shares", "FVS") {
    ...
    function depositFees(uint256 amount) external override onlyRole(DEPOSITOR_ROLE) nonReentrant {
    ...
    function totalAssets() public view override(ERC4626, IFeeVault) returns (uint256) {
    ...
    function convertToAssets(uint256 shares) public view override(ERC4626, IFeeVault) returns (uint256 assets) {
    ...
    function convertToShares(uint256 assets) public view override(ERC4626, IFeeVault) returns (uint256 shares) {
